function traerReporteStatus() {
    console.log("Test");
    $.ajax({
        url:"http://129.151.100.76:8080/api/Reservation/report-status",
        type:"GET",
        datatype:"JSON",
...
function traerReporteDate() {
    ...
    $.ajax({
        url:"http://129.151.100.76:8080/api/Reservation/report-dates/" + fechaInicio + "/" + fechaCierre,
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function traerReporteClientes() {
    $.ajax({
        url:"http://129.151.100.76:8080/api/Reservation/report-clients",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function pintarRespuestClientes(respuesta) {
    let myTable = "<table class='ui center aligned celled table'>" + 
